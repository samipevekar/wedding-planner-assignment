ify the parent component

This ensures that the storage always contains the correct data after a delete operation, preventing the issue where deleted guests reappear when navigating back to the screen.

ye work nai kr rha hai ek kam kro na jo jo function sab jagah use ho rhe hai usko dalo alg file me or direct call kro phr maybe sab thik ho jaye
Aap bilkul sahi keh rahe hain! Problem yeh hai ki multiple jagah state manage ho raha hai aur storage operations inconsistent hain. Main ek centralized service bana deta hoon jahan sab functions honge aur sab jagah se direct call karenge.

Pehle ek new service file banate hain:

1. Pehle GuestService.js file banayein
javascript
...
2. Ab HomeScreen.js ko update karein
javascript
...
import { loadGuests, addGuest, deleteGuest, clearAllGuests, getGuestStats } from '../services/GuestService';
