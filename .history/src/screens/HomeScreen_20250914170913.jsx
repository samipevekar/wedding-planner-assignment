...
const HomeScreen = ({ navigation }) => {
  ...
  const [randomGuestLoading, setRandomGuestLoading] = useState(false)

  const handleRandomGuest = async () => {
    setRandomGuestLoading(true)
    try {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.formSection}>
          <AddGuestForm onAddGuest={handleAddGuest} onRandomGuest={handleRandomGuest} randomGuestLoading={randomGuestLoading} />
        </View>
