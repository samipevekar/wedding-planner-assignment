...
const GuestList = ({ route }) => {
  ...
  const stats = useMemo(() => {
    ...
    const confirmed = filteredGuests.filter(g => g.rsvpStatus === 'Yes').length;
    const maybe = filteredGuests.filter(g => g.rsvpStatus === 'Maybe').length;
    const declined = filteredGuests.filter(g => g.rsvpStatus === 'No').length;
